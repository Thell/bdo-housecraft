...
class Regioninfo(KaitaiStruct):
    ...
    class RegioninfoType(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.village_tax_rate_by_level = self._io.read_u2le()
            ...
            self.unknown_33 = self._io.read_u8le()
            self.guild_wharf_character_key = self._io.read_u2le()
